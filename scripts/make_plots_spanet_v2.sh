...
#            features_8
#	do
#		python scripts/plot/validation.py $MODELS_DIR/$TTHBB_DIR/$FEATURES_DIR/binary_classifier_full_Run2_batch8092_lr${LR}/lightning_logs/version_0 --cfg $PARAMS_DIR/$TTHBB_DIR/$FEATURES_DIR/run_parameters_${TTHBB_DIR}.yaml --plot_dir plots_CR -j 10
#	done
#done
