...
# create dataset in SR
# Create datasets in CR2
MAX=1p00
for CAT in tthbb_0p75To1p00
do
    python scripts/dataset/parquet_to_dctr.py --cfg parameters/spanet_v2/SR/${CAT}/data_preprocessing_SR_${CAT}.yaml -o /eos/user/m/mmarcheg/ttHbb/dctr/training_datasets/spanet_v2_extrapolation/${CAT}_ttlf0p30/dataset_dctr_${CAT}_ttlf0p30_2018.parquet
done
